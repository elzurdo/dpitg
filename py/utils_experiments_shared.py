...
def create_decision_correctness_df(method_stats, true_value, rope_min, rope_max, data_type='binomial'):
    ...
    TODO: This solves for absolute decision correctness of accept/reject
          ...
          This most likely should not impact PitG or DPiTG but it might impact HDI+ROPE
...
def correctness_stats(df_experiment_correctness):
    ...
    cols_inconclusive = ['hdi_rope_inconclusive', 'pitg_inconclusive', 'dpitg_inconclusive']
    cols_correctness = ['hdi_rope_decision_correct', 'pitg_decision_correct', 'dpitg_decision_correct']
...
# Was called sims_hypo_to_correctness_stats
def get_correctness_stats_per_truth(sims_hypo_results):
    inconclusive_rates = {}
    correctness_rates = {}
